...
public class Parameters {
    ...
    public enum SchedulingAlgorithm {
        ...
        STATIC, FCFS, ROUNDROBIN, CBMW, NOSF, CEWB, INVALID
    }
    ...
    public enum PlanningAlgorithm{
        INVALID, RANDOM, HEFT, DHEFT, CBMW_STATIC
    }
    ...
    /** CBMW: deadline tightness factor (1.2 = tight, 3.0 = loose). */
    private static double tightness = 1.2;
    /** CBMW: workflow arrival rate (workflows per minute). */
    private static double arrivalRate = 2.0;
    /** CBMW: total simulation duration in seconds. */
    private static double simDuration = 3600.0;
    ...
    public static void setTightness(double t) { tightness = t; }
    public static double getTightness() { return tightness; }
    public static void setArrivalRate(double r) { arrivalRate = r; }
    public static double getArrivalRate() { return arrivalRate; }
    public static void setSimDuration(double d) { simDuration = d; }
    public static double getSimDuration() { return simDuration; }
}
