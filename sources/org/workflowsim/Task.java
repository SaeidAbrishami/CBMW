...
public class Task extends Cloudlet {
    ...
    /** Latest Start Time assigned by CBMW static planner. */
    private double latestStartTime = Double.MAX_VALUE;

    /** Workflow ID this task belongs to (used by CBMW). */
    ...
    public void setLatestStartTime(double lst) { this.latestStartTime = lst; }
    public double getLatestStartTime() { return this.latestStartTime; }
    public void setWorkflowId(int wfId) { this.workflowId = wfId; }
    public int getWorkflowId() { return this.workflowId; }
