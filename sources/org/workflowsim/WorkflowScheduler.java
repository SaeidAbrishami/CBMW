...
import org.workflowsim.cbmw.baselines.NOSFSchedulingAlgorithm;
import org.workflowsim.cbmw.baselines.CEWBSchedulingAlgorithm;
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            case ROUNDROBIN:
                ...
                break;
            case CBMW:
                algorithm = new CBMWDynamicSchedulingAlgorithm();
                break;
            case NOSF:
                algorithm = new NOSFSchedulingAlgorithm();
                break;
            case CEWB:
                algorithm = new CEWBSchedulingAlgorithm();
                break;
            default:
                algorithm = new StaticSchedulingAlgorithm();
                break;
